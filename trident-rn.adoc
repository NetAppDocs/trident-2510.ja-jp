...
NetAppは、製品とサービスを継続的に改善し、強化しています。Tridentの最新機能の一部を以下に示します。以前のリリースについては、 https://docs.netapp.com/us-en/trident/earlier-versions.html["以前のバージョンのドキュメント"]を参照してください。
