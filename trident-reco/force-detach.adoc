...
NOTE: 以下のlink:..trident-reco/force-detach.html#integrating-custom-node-health-check-solutions["カスタムノードヘルスチェックソリューションの統合"]セクションで指定されている別の方法を使用して、ノード障害を検出することもできます。
