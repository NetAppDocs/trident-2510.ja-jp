...
summary: バージョンセレクタを使用して最新バージョンと以前の4つのバージョン間を移動するか、以下のリンクを使用できます。 
---
= 以前のバージョンのドキュメント
:hardbreaks:
:allow-uri-read: 
...
[role="lead"]
Trident 25.10を実行していない場合は、以前のリリースのドキュメントがlink:get-help.html["Tridentサポートライフサイクル"]に基づいて利用できます。
